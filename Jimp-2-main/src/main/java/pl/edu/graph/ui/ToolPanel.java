...
public class ToolPanel extends JPanel {
    ...
    private JButton simplePartitionButton;
    ...
    public ToolPanel() {
        ...
        // Add a simple partitioning button
        gbc.gridx = 0;
        gbc.gridy++;
        gbc.gridwidth = 2;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        simplePartitionButton = new JButton("Simple 2-Color Partition");
        simplePartitionButton.setEnabled(false);
        add(simplePartitionButton, gbc);
    ...
    public void setSimplePartitionAction(ActionListener action) {
        simplePartitionButton.addActionListener(action);
    }
    
    public void setGraphLoaded(boolean loaded) {
        partitionButton.setEnabled(loaded);
        simplePartitionButton.setEnabled(loaded);
    }
